...
$experience = [
    [
        ...
        'description' => 'Описание опыта работы ландшафтным дизайнером.',
    ],
    [
        'name' => 'Аудитор',
        'dateStart' => 'Март 2012',
        'dateEnd' => 'Декабрь 2014',
        'description' => 'Описание опыта работы аудитором.',
    ],
    [
        'name' => 'Бухгалтер',
        'dateStart' => 'Июнь 2010',
        'dateEnd' => 'Март 2012',
        'description' => 'Описание опыта работы бухгалтером. ',
    ],
];
?>
          ...
          <?php for ($i = 0; $i < count($experience); $i++): ?>
            ...
            <h5 class="w3-opacity"><b><?=$experience[$i]['name'];?></b></h5>
              <h6 class="w3-text-teal">
                ...
                <?=$experience[$i]['dateStart'];?> - 
                <?php if ($i == 0): ?>
                  <span class="w3-tag w3-teal w3-round">
                    <?=$experience[$i]['dateEnd'];?>
                  </span>
                <?php else: ?>
                  <?=$experience[$i]['dateEnd'];?>
                <?php endif; ?>
